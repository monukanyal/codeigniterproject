            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        ?>
                            ...
                            <tbody>
                                ...
                                <tr class="even pointer">
                                    ...
                                    <td class=" "><?php echo $row['ad_days'];?></td>
                        ...
                        <td class=" last">
                            <a href="<?php echo site_url('users/show/'.$row['id']); ?>" class="btn btn-primary btn-xs" title="Show"><i class="fa fa-info-circle"></i></a>
                            <a href="<?php echo site_url('users/edit/'.$row['id']); ?>" class="btn btn-info btn-xs" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
                            <a href="<?php echo site_url('users/delete/'.$row['id']); ?>" class="btn btn-danger btn-xs" title="Delete" onclick="return confirm('Do you want to permanent delete this user member?')"><i class="fa fa-trash"></i></a>
                            <a href="<?php echo site_url('users/reset/'.$row['id']); ?>" class="btn btn-info btn-xs" title="Reset"><i class="fa fa-pencil"></i></a>
                        </td>
                                </tr>
                                <?php } 
                                }
