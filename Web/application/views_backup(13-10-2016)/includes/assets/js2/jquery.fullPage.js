        ...
        function activateNavDots(name, sectionIndex){
            if(options.navigation){
                ...
                if(name){
                    ...
                    disableScroll();
                    // var movement=$("#movement_val").val();
                    // if ((movement=='down') && (sectionIndex==0)){
                    //     console.log(movement);
                    //     disableScroll();
                    // }
                    // if ((movement=='down') && sectionIndex==2){
                    //     console.log(movement);
                    //     enableScroll();
                    // }
                    // if ((movement=='up') && (sectionIndex==2 || sectionIndex==1)){
                    //     console.log(movement);
                    //     disableScroll();
                    // }
                    // if ((movement=='up') && sectionIndex==0){
                    //     console.log(movement);
                    //     enableScroll();
                    // }
                    ...
                    else if ((movement=='down') && (sectionIndex==2)){
                        enableScroll();
                    }
                    else{
                       disableScroll(); 
