        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    ...
                    <button onClick="window.location='<?php echo site_url('event/calendar'); ?>'" class="btn btn-info btn-xs">Calendar View</button>
                </div>
                        ...
                        ?>
                                ...
                                <tbody>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class=" "><?php echo isset($arrEvent)?$arrEvent['name']:'--';?></td>
