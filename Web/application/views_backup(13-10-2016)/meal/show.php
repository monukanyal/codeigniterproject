        ...
        <div class="">
            ...
            <div class="page-title">
                <div class="title_left">
                    <h3>Meal Management <small>Detail - "<?php echo $meal_info['name'];?>"</small></h3>
                </div>
            ...
            <div class="row">
              ...
              <!-- meal information Start from here -->
                          ...
                          <div class="col-m-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-m-8 col-sm-8 col-xs-12">
                                  <span class="user-infor">
                                    <?php echo $meal_info['name']; ?>
                                  </span>
                                </div>
                            </div>
                            <div class="form-group">
                              <div class="col-m-12 col-sm-12 col-xs-12 no-padd">
                                <div class="col-m-4 col-sm-4 col-xs-12">
                                  <span class="type-info">
                                    Description
                                  </span>
                                ...
                                <div class="col-m-8 col-sm-8 col-xs-12">
                                  <span class="user-infor">
                                    <?php echo ($meal_info['description']!="")?$meal_info['description']:'--'; ?>
                                  </span>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <div class="col-m-12 col-sm-12 col-xs-12 no-padd">
                                ...
                                <div class="col-m-8 col-sm-8 col-xs-12">
                                  <span class="user-infor">
                                    <?php echo mdate('%d %M %Y %h:%i %A',strtotime($meal_info['start_date'].$meal_info['start_time']));?>
                                  </span>
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="col-m-12 col-sm-12 col-xs-12 no-padd">
                                ...
                                <div class="col-m-8 col-sm-8 col-xs-12">
                                  <span class="user-infor">
                                    <?php echo mdate('%d %M %Y %h:%i %A',strtotime($meal_info['end_date'].$meal_info['end_time']));?>
                                  </span>
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="col-m-12 col-sm-12 col-xs-12 no-padd">
                                ...
                                <div class="col-m-8 col-sm-8 col-xs-12">
                                  <span class="user-infor">
                                    <?php if($meal_info['is_active'] == true) {
                            ...
                            <div class="form-group">
                              <div class="col-m-12 col-sm-12 col-xs-12 no-padd">
                                ...
                                <div class="col-m-8 col-sm-8 col-xs-12">
                                  <span class="user-infor">
                                    <?php echo mdate('%d %M %Y %h:%i %A',strtotime($meal_info['logtime'])); ?>
                                  </span>
                                </div>
                              </div>
                            </div>
                              ...
                              <div class="show-detail text-center">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-m-6 col-sm-6 col-xs-12 right-border">
                                    ...
                                    <?php
                                      if($meal_info['list_users'] != "")
                                      {
                                        $arrListUsers = explode(",", $meal_info['list_users']);
                                  ...
                                  <div class="col-m-6 col-sm-6 col-xs-12 left-border">
                                    ...
                                    <?php
                                      if($meal_info['attend_users'] != "")
                                      {
                                        $arrAttendUsers = explode(",", $meal_info['attend_users']);
