...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://52.88.242.243/application/views/includes/assets/css2/bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="http://52.88.242.243/application/views/includes/assets/css2/bootstrap-theme.min.css" />
    <link rel="stylesheet" type="text/css" href="http://52.88.242.243/application/views/includes/assets/css2/animation-effects.css" />
    <link rel="stylesheet" type="text/css" href="http://52.88.242.243/application/views/includes/assets/css2/custom.css" />
    <link rel="stylesheet" type="text/css" href="http://52.88.242.243/application/views/includes/assets/css2/jquery.fullPage.css" />
    <style>
        .done
        {
...
$(function(){
  $("#update").click(function(e){
    ...
    $.ajax({
       url:'http://52.88.242.243/index.php/Password_rest/Update_password',
       type: 'POST',
