                    ...
                    <div class="signup modal fade" id="firstModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <div class='message error'></div>  
        <form action="/index.php/payments_pro/Set_express_checkout" method="post">      
                            <div>
                ...
                <div class="container caption-sec">
                    <center>
                        ...
                        <button class="btn btn-primary blue"><a href="/index.php/subscription" class="modal_signup">START OUR FREE TRAIL NOW</a></button>
                    </center>
                </div>
            </section>
