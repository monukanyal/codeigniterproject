        ...
        <header id="header" class="header">
            <div class="container">
                <div class="pull-left logo-section">
                    <a href="http://52.88.242.243/index.php">
            ...
            <div class="container">
                ...
                <div class="col-md-8">
                    ...
                    <form action="/index.php/payments_pro/Set_express_checkout" method="post" class="update-form">
                 ...
                 <div class="paypall">
                    <div class="row">
                       <div class="col-md-12 paypall_icon1">
                            <img src="http://52.88.242.243/application/views/includes/assets/images2/paypal_icon.png" alt="">
                        </div>
