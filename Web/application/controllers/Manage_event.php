...
class Manage_event extends CI_Controller {
	...
	function show() {		
		...
		{
			$day=7;  //by default 7 days
		}

		 $data['getdata']=$this->Event_model->get_event_datewise_data($manage_eventId,$day,$admin_id);
		 $data['day']=$day;
	...
	//@MKCODE
	function getdata_event_ajax()
	{
		$admin_id=$_POST['admin_id'];
		$event_id=$_POST['event_id'];
		//$day=$_POST['day'];
		$day=1000;
		$this->Event_model->get_event_datewise_ajax($event_id,$day,$admin_id);
	}
	//-----
	...
	*************************/
	...
	function add() {
		...
		{
			$this->form_validation->set_rules('name', 'Name', 'trim|required|max_length[50]|is_unique[ci_event.name]');
