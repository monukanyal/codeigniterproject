...
class Payflow extends CI_Controller 
{
	...
	function index()
	{
		$this->load->view('paypal/samples/payflow');
	}
	...
	function Process_transaction()
	{
		...
		$PayPalRequestData = array(
				...
				'acct'=>'4111111111111111', // Required for credit card transaction.  Credit card or purchase card number.
				'expdate'=>'0621', 			// Required for credit card transaction.  Expiration date of the credit card.  Format:  MMYY
				'amt'=>'1.00',				// Required.  Amount of the transaction.  Must have 2 decimal places.
				'dutyamt'=>'', 				//
				//'freightamt'=>'5.00', 	//
				//'taxamt'=>'2.50', 		//
				'taxexempt'=>'', 			//
				...
				'billtoemail'=>'varsha@esferasoft.com', // Account holder's email address.
				'billtophonenum'=>'4083660038', 	// Account holder's phone number.
				'billtofirstname'=>'varsha', 		// Account holder's first name.
				...
				'billtocountry'=>'US', 	// Bill to Country.  3 letter country code.
