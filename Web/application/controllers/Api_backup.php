	...
	{	//$care_id='483';
		...
		if(!empty($care_id))
		{
			...
			if(!empty($status))
			{
				...
				return array('status'=>'success','message'=>'Care needs approval by Admin .','response'=>$status['approve']);	
			}
			else
			{
