...
class Event extends CI_Controller {
	...
	*************************/
	function _generateform($default_data,$validate=0,$current_url,$default_data11)
	{
		...
		$data['form']['meetup_time']['field']=form_input(array('name'=>'meetup_time','type'=>'text','id'=>'meetup_time','value'=>'08:00 AM','class'=>'form-control','autofocus'=>'true','onkeydown'=>'return false'));

		$data['form']['end_time']['label']=form_label('End Time','end_time');
		$data['form']['end_time']['field']=form_input(array('name'=>'end_time','type'=>'text','id'=>'end_time','value'=>'08:30 AM','class'=>'form-control','autofocus'=>'true','onkeydown'=>'return false'));
	...
	function add() {
		...
		if(isset($_POST['submit'])) 
		{
			...
			$this->form_validation->set_rules('end_time', 'End Time', 'required|callback_check_equal_less['.$this->input->post('meetup_time').']');
