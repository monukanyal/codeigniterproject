...
class Meal extends CI_Controller {
	...
	*************************/
	function _generateform($default_data,$validate=0,$current_url,$default_data11)
	{
		...
		$data['form']['start_time']['field']=form_input(array('name'=>'start_time','type'=>'text','id'=>'start_time','value'=>'08:00 AM','class'=>'form-control','autofocus'=>'true','onkeydown'=>'return false'));
	...
	function add() {
		...
		if(isset($_POST['submit'])) 
		{
			...
			$this->form_validation->set_rules('end_time', 'End Time', 'required|callback_check_equal_less['.$this->input->post('start_time').']');
