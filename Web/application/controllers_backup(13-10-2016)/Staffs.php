...
class Staffs extends CI_Controller {
	...
	public function index()
	{
		...
		$data['arrUser'] = $this->Staffs_model->get_alluser();
		//echo "<pre>";
		//print_r($data);
		//echo "</pre>";
		...
		$this->load->view('super_dashboard/Staffs/index',$data);
	...
	function show($userId) {		
		...
		$data['user_info']=$this->Staffs_model->get_user(array("id" => $userId));

		$data["assets_path"] = base_url().$this->config->item('assets_path');
		$this->load->view('includes/partials/super_admin/header',$data);
		$this->load->view('includes/partials/super_admin/sidebar',$data);
		$this->load->view('includes/partials/super_admin/topmenu',$data);
		$this->load->view('super_dashboard/Staffs/show',$data);
		$this->load->view('includes/partials/footer',$data);
	}
...
//print_r($def_data);
		...
		$data['user_info']=$this->Staffs_model->update(array("id" => $userId),$def_data ,'ci_staff');

		$data["assets_path"] = base_url().$this->config->item('assets_path');
		$this->load->view('includes/partials/super_admin/header',$data);
		$this->load->view('includes/partials/super_admin/sidebar',$data);
		$this->load->view('includes/partials/super_admin/topmenu',$data);
		$this->load->view('super_dashboard/Staffs/reset',$data);
		$this->load->view('includes/partials/footer',$data);
	}
	/************************
	* To generate form
	*************************/
	function _generateform($default_data,$validate=0,$current_url)
	{
		...
		$data['form']['about']['field']=form_input(array('name'=>'about','type'=>'text','id'=>'about','value'=>$default_data['about'],'class'=>'form-control','autofocus'=>'true'));
	...
	function add() {
		...
		if(isset($_POST['submit'])) 
		{
			...
			{   		
			    ...
			    $id_record=$this->user_model->insert($default_data, 'ci_staff');
		...
		$this->load->view('includes/partials/super_admin/sidebar',$data);
		$this->load->view('includes/partials/super_admin/topmenu',$data);
		$this->load->view('super_dashboard/about/add',$data);
		$this->load->view('includes/partials/footer',$data);
	}
	...
	function edit($userId,$start=0)
	{
		...
		$edit_data=$this->Staffs_model->get_user(array("id" => $userId));
		...
		if(isset($_POST['submit'])) 
		{
			...
			if($this->form_validation->run() == TRUE)				
			{
			    ...
			    $id_record=$this->Staffs_model->update($data_feed, $default_data, 'ci_staff');
		...
		$this->load->view('includes/partials/super_admin/sidebar',$data);
		$this->load->view('includes/partials/super_admin/topmenu',$data);
		$this->load->view('super_dashboard/Staffs/add',$form_data);
		$this->load->view('includes/partials/footer',$data);
	}
	...
	public function delete($userId)
	{
		...
		$id_record=$this->Staffs_model->delete($default_data, 'ci_staff');
