   <!-- page content -->
    <div class="right_col" role="main">
                        ...
                        <div class="x_title">
                         ...
                         <button type="button" id="msgsend" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal">Send Message </button>
                            ...
                            <ul class="nav navbar-right panel_toolbox">
                                ...
                                <li><button onClick="window.open('<?php echo site_url().'/user/add'; ?>','_self');" class="btn btn-info btn-xs">Add New</button></li>
        ...
        <a href="<?php echo site_url('Plivo_test/resend_sms/'.$row['id']); ?>" class="btn btn-primary btn-xs" title="Resend Message"><i class="fa fa-envelope"></i></a>
                                    <?php } ?>
        <a href="<?php echo site_url('user/childindex/'.$row['id']); ?>" class="btn btn-primary btn-xs" title="View Child"><i class="fa fa-share"></i></a>
