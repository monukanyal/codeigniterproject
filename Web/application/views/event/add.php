...
<script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      $('#meetup_date').datepicker( { defaultDate: new Date(), minDate: 0,dateFormat: "yy-mm-dd", changeYear: true, yearRange:  "+0:+5",onSelect: function(dateText, inst) { 
        $("#end_date").datepicker('option', 'minDate', dateText);
        // $('#end_date').val(dateText);
      }}); 
      
      var currentDate1 = $("#meetup_date").val(currentDate); 
      ...
      if(currentDate1 ==''){
        ...
        $('#meetup_time').timepicker({ 'step': 15 ,'timeFormat': 'h:i A','defaultTime': '8:00 AM'});
      ...
      $('#end_time').timepicker({ 'step': 15,'timeFormat': 'h:i A' });
