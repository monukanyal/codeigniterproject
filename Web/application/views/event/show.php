        ...
        <div class="">
            ...
            <div class="page-title">
                <div class="title_left">
                    <h3>Activity Management </small></h3>
                </div>
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <ul class="nav navbar-right panel_toolbox">
                                <li><button onClick="window.location='<?php echo site_url('event'); ?>/edit/<?php echo $eventid; ?>'" class="btn btn-info btn-xs">Event Edit</button></li>

                            <li>
                            <button onClick="window.open('<?php echo site_url().'/Pdfexample'; ?>');" class="btn btn-info btn-xs">Calender PDF</button></li>
