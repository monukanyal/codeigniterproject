        ...
        <div class="">
            ...
            <div class="page-title">
                <div class="title_left">
                    <h3>Site Admins Management 
                    <?php if($this->router->fetch_method()=='add')
                        echo "<small>Add New Site Admins</small></h3>";
                    else
                        echo "<small>Edit Site Admins</small></h3>";
                    ?>
                </div>
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <ul class="nav navbar-right panel_toolbox">
                                <li><button onClick="window.location='<?php echo site_url('organization'); ?>'" class="btn btn-info btn-xs">Organization List</button></li>
